...
- **9 Artefacts + 10 mockups + WFD Wireframes = highest effort + highest review risk** — split across 3 different owners and run fully parallel from Day 1.
- **System Access** is critical but lightweight — close by end of Week 1 to avoid blocking everything else.
- **Design Quality Obligation (DCA §11A)** introduces independent PD rejection grounds — mockups + design direction statement must reach **premium consumer safety app** standard, not just minimum spec.
