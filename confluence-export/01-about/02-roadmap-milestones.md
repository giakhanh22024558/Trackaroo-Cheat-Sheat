...
| Foundation acceptance criteria (AC-C1→C10) | 45 | Sprint 0 — see [`sprint-0-foundation-criteria.md`](../../docs/sprint-0-foundation-criteria.md) |
...
- **B2.1 Tasks** — what to do (inline below)
- **B2.2 Topic → Concern → Acceptance Criteria** — quality requirements, **moved to** [`sprint-0-foundation-criteria.md`](../../docs/sprint-0-foundation-criteria.md) for separate BA analysis (45 ACs across 5 Topics / 10 Concerns)
- Time → [Sprint 0 Gantt](#a2-sprint-by-sprint-execution) · committed artefacts → [§B5](#b5-discovery-gate-deliverable-register)
...
Moved to its own file for separate BA analysis: 📄 [`sprint-0-foundation-criteria.md`](../../docs/sprint-0-foundation-criteria.md).

Quick overview (5 Topics → 10 Concerns → 45 ACs):
...
> Cross-references to specific criteria (e.g. `AC-C1-02`, `AC-C8-05`) elsewhere in this file resolve to the moved register.
