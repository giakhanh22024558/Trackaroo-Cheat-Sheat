...
| 06 | [Registers — per-register templates](./registers/) | 9 live registers (DCA §7) — each register has its own template file with schema + maintenance + reporting integration. **Split out:** [Risk](./registers/risk.md) · [Decision](./registers/decision.md). Remaining 6 (Defect · Dependency · OSS · SDK · AI-tool · Change) in [`06-register-schemas.md`](./06-register-schemas.md) until split. | §6.10.2 / DCA §7 | `[CMP-5026] Register — [Name]` |
