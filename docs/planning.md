...
| Foundation acceptance criteria (AC-C1→C10) | 45 | Sprint 0 — see [`sprint-0-foundation-criteria.md`](./sprint-0-foundation-criteria.md) |
...
- **B2.2 Topic → Concern → Acceptance Criteria** — quality requirements, **moved to** [`sprint-0-foundation-criteria.md`](./sprint-0-foundation-criteria.md) for separate BA analysis (45 ACs across 5 Topics / 10 Concerns)
...
Moved to its own file for separate BA analysis: 📄 [`sprint-0-foundation-criteria.md`](./sprint-0-foundation-criteria.md).
